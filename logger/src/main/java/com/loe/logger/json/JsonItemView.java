...
public class JsonItemView extends LinearLayout {
    ...
    private void initView() {
        ...
        LayoutInflater.from(mContext).inflate(R.layout.logger_jsonviewer_layout_item_view, this, true);
    ...
    public void showIcon(boolean isPlus) {
        ...
        mIvIcon.setImageResource(isPlus ? R.drawable.logger_jsonviewer_plus : R.drawable.logger_jsonviewer_minus);
