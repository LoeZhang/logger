...
public class JsonViewerAdapter extends BaseJsonViewerAdapter<JsonViewerAdapter.JsonItemViewHolder> {
    ...
    public JsonViewerAdapter(String jsonStr, Context context) {
    ...
    public JsonViewerAdapter(JSONObject jsonObject, Context context) {
        this.context = context;
    ...
    public JsonViewerAdapter(JSONArray jsonArray, Context context) {
        this.context = context;
    ...
    private void handleJsonObject(String key, Object value, JsonItemView itemView, boolean appendComma, int hierarchy) {
        ...
        handleValue(key, value, itemView, appendComma, hierarchy);
    }
     ...
     * @param hierarchy   缩进层级
     */
    private void handleValue(final String key, Object value, JsonItemView itemView, boolean appendComma, int hierarchy) {
        final SpannableStringBuilder valueBuilder = new SpannableStringBuilder();
        ...
        itemView.setOnLongClickListener(new View.OnLongClickListener()
        {
            ...
            public boolean onLongClick(View view)
            {
                try
                {
                    LoggerTools.copyToClipboard(context, key + " : " + valueBuilder.toString());
